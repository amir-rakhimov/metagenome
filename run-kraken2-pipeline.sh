...
job_id1=$(sbatch --parsable --export=ALL code/slurm-scripts/001-kraken2-build.slurm)
job_id2=$(sbatch --parsable --dependency=afterok:$job_id1 --export=ALL code/slurm-scripts/002-kraken2-pipeline.slurm)
